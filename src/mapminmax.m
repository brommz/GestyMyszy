...
%
%with ymax and ymin being your 500 and 1, respectively, 
%and where xmax and xmin are column vectors of the maximum and minimum values along each of the rows of x.
